...
.box{
    ...
    #submit:hover{
        background-image: linear-gradient(to right,rgb(0,92,197),rgb(69, 18, 162));
    }
</style>
<body>
    <div class="box">
        <form action="Formulario.php" method="POST">
            <fieldset>
                ...
                <br><br>
                    ...
                    <p>Sexo:</p>
                    <input type="radio" id="feminino" name="genero" value="feminino" reqired>
                    <label for="feminino">Feminino</label>
                    <br>
                    <input type="radio" id="masculino" name="genero" value="masculino" reqired>
                    <label for="masculino">Masculino</label>
                    <br>
                    <input type="radio" id="outro" name="genero" value="outro" reqired>
